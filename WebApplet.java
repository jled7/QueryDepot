...
public class WebApplet extends JApplet {
    ...
    public final void cargarConsultas(String rutaFichero) throws FileNotFoundException, IOException, URISyntaxException{
         //URL url = new URL("http://www.ietf.org/id/draft-hoehrmann-cp-collation-01.txt");
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                try {
                    ...
                    getAppletContext().showDocument(new URL("https://www.google.com/search?q="+textArea.getText()+"&ie=utf-8&oe=utf-8"));
    ...
    public void buttonActionPerformed(ActionEvent ev) {
       ...
       String [] arrayTheQuerys = querys.split(",");
        ...
        try {
            ...
            //getAppletContext().showDocument(new URL("javascript:show("+arrayTheQuerys+");"));
