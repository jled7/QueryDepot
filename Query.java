...
/**
Las operaciones de creación se definirán mediante constructores para cada una de las
implementaciones posibles de la interfaz (dado que no es posible definir un constructor en una
interfaz en Java).
